	...
	public static void main(String[] args) {
    	...
    	while(true){
	        try 
	        {
	        	...
	        	System.out.println("Velg størrelse på heltall fra 0 til :");
	        	...
	        	case 2: 
	        		if(test_case.equals(y))
	        		{
		            	...
		            	System.out.printf("Quicksort\t: %6.3f s\n", time/1000.0);
	 	            	...
	 	            	int T = 0;
	 	            	/*
	 	            	 * Her skjer det noe når man kjører loopen 5 ganger, man får stack overflow
	 	            	 * så fort n blir noe særlig større enn 20000. Så jeg velger å ikke kjøre loop rundt denne.
	 	            	 * Denne algoritmen er fra Jan's forelesninger, så jeg skal høre med han hva som skjer.
	 	            	 */
